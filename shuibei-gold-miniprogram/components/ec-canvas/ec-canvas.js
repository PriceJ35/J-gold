    ...
    initByNewWay(callback) {
      ...
      query
        ...
        .exec(res => {
          ...
          if (typeof callback === 'function') {
            this.chart = callback(canvasNode, canvasWidth, canvasHeight, canvasDpr)
          } else if (this.data.ec && typeof this.data.ec.onInit === 'function') {
            this.chart = this.data.ec.onInit(canvasNode, canvasWidth, canvasHeight, canvasDpr)
          } else {
            this.triggerEvent('init', {
              canvas: canvasNode,
              width: canvasWidth,
...
function WxCanvas(ctx, canvasId, isNew, canvasNode) {
  ...
  if (isNew) {
    ...
    this.canvas.width = canvasNode.width;
    this.canvas.height = canvasNode.height;
  } else {
    this._initStyle(ctx);
  }

  // this._initCanvas(zrender, ctx);
  this._initStyle = _initStyle;
